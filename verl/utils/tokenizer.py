...
def get_processor(model_path: str, **kwargs) -> Optional[ProcessorMixin]:
    ...
    try:
        ...
        #        "Qwen/Qwen2.5-VL-7B-Instruct", trust_remote_code=True, **kwargs
        #    )
        #elif "exp_SFT_mix_v3" in model_path:
        #    processor = AutoProcessor.from_pretrained(
        #        "Qwen/Qwen2.5-VL-3B-Instruct", trust_remote_code=True, **kwargs
        #    )
        #elif "7b" in model_path:
        #    processor = AutoProcessor.from_pretrained(
        #        "Qwen/Qwen2-VL-7B-Instruct", trust_remote_code=True, **kwargs
        #    )
